            ...
            <div className="ask-ques-container">
                ...
                <form onSubmit={handleSubmit}>
                    ...
                    <label htmlFor="ask-ques-title">
                        ...
                        <input type="text" onChange={(e)=>{setQuestionTitle(e.target.value)}} placeholder="e.g. Is there any function to trace actual location of a user?" id="ask-ques-title"/>
                    </label>
                    ...
                    <label htmlFor="ask-ques-tags">
                        ...
                        <input type="text" onChange={(e)=>{setQuestionTags(e.target.value.split(" "))}} placeholder="e.g. (xml typescript wordpress javascript)" id="ask-ques-title"/>
                    </label>
                    </div>
